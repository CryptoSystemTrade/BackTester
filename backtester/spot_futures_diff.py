...
spot_columns = [
    'open_time', 'open_s', 'high_s', 'low_s', 'close_s', 'volume_s',
    'close_time', 'quote_asset_volume_s', 'number_of_trades_s',
    'taker_buy_base_asset_volume_s', 'taker_buy_quote_asset_volume_s',
    'ignore_s'
]
